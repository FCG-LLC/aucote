...
class Storage(DbInterface):
    ...
    def _save_node(self, node, protocol):
        """
    ...
    def _save_nodes(self, nodes, protocol):
        """
    ...
    def _get_nodes(self, pasttime, timestamp, protocol):
        """
    ...
    def _get_ports_by_node(self, node, timestamp, protocol):
        """
        Query for port scan detail from scans from pasttime ago
    ...
    def _get_ports_by_nodes(self, nodes, timestamp, protocol):
        """
        Query for port scan detail from scans from pasttime ago
    ...
    def save_node(self, node, protocol):
        """
    ...
    def save_nodes(self, nodes, protocol):
        """
    ...
    def get_nodes(self, protocol, pasttime=0, timestamp=None):
        """
    ...
    def get_ports_by_node(self, node, protocol, pasttime=0, timestamp=None):
        """
    ...
    def get_ports_by_nodes(self, nodes, protocol, pasttime=0, timestamp=None):
        """
