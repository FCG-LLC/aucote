...
class CVESearchVulnerabilityResultTest(TestCase):
    ...
    def test_init(self):
        result = CVESearchVulnerabilityResult.from_dict(self.PARSED_JSON)
...
class CVESearchVulnerabilityResultsTest(TestCase):
    ...
    @patch('tools.cve_search.structs.CVESearchVulnerabilityResult.from_dict')
    def test_from_dict(self, mock_result):
        data = [1, 2]
