...
https://jenkins.cs.int/login?from=%2Fa%3Fa%3Dwe%252520wqe [200 OK] Cookies[JSESSIONID.6d81b00c]"""
    ...
    OUTPUT = """http://10.12.2.159:1032 [200 OK] JQuery, PasswordField[pma_password]"""
    ...
    def test_parse_line(self):
        ...
        self.parser._parse_plugin_string.assert_has_calls((call('JQuery'), call(' PasswordField[pma_password]')))
